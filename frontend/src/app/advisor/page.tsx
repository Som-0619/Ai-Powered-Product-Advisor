    ...
    <div className="flex flex-col items-center w-full max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-2">
      ...
      {activeTab === "chat" ? (
        ...
        <div className="w-full space-y-8 animate-in fade-in duration-200">
          {/* Hero Section */}
          <section className="text-center max-w-2xl mx-auto pt-6 pb-4">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground">
              Find the right product.
            </h1>

            <p className="text-sm sm:text-base text-muted-foreground mt-2.5 max-w-xl mx-auto leading-relaxed">
            ...
            <form
              ...
              className="mt-6 max-w-xl mx-auto w-full relative z-10"
            >
              <div className="rounded-xl p-1.5 flex items-center bg-card border border-border shadow-sm hover:border-slate-300 dark:hover:border-white/20 transition-all gap-2">
                <Search className="w-4 h-4 text-muted-foreground ml-2.5 shrink-0 pointer-events-none" />
                <input
                  type="text"
                  value={query}
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold flex items-center space-x-1.5 transition-all shrink-0 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
                >
                  {isLoading ? (
            ...
            <div className="flex flex-wrap items-center justify-center gap-1.5 mt-3.5">
              ...
              <button
                ...
                className="px-3 py-1 rounded-full text-xs font-medium bg-surface-100 hover:bg-surface-200 text-foreground border border-border transition-all cursor-pointer"
              >
                Smartphones
              </button>
              <button
